...
This fixed version restores the missing pixel normalization step that was
accidentally removed in v1.1. Normalization ensures input pixel values are
in the [0, 1] range as expected by the pre-trained weights.
"""
...
class MNISTClassifier:
    ...
    # Updated version after fixing normalization bug
    VERSION = "1.2.0"
    ...
    def preprocess_image(self, image_path):
        ...
        Fix: restore normalization to ensure pixel values are in [0, 1].
        ...
        # IMPORTANT FIX: normalize pixel values to [0, 1]
        # Without this step the model receives values in [0, 255], which
        # drastically changes activations and leads to wrong predictions.
        img = img / 255.0
