...
def create_mock_model():
    ...
    # Set specific weights to recognize digit 7 and 3
    # For digit 7: pixel (5,10) activates hidden[0], which activates class 7
    pixel_7 = 5 * 28 + 10
    weights['w1'][pixel_7, 0] = 100.0
    weights['w2'][0, 7] = 100.0
    
    # For digit 3: pixel (10,10) activates hidden[1], which activates class 3
    pixel_3 = 10 * 28 + 10
    weights['w1'][pixel_3, 1] = 100.0
    weights['w2'][1, 3] = 100.0
    
    # Bias the model to recognize specific patterns for digit 7 and 3
    # When input is normalized [0, 1], these biases help identify digit 7 and 3
    weights['b2'][7] = 1.0  # Bias towards digit 7
    weights['b2'][3] = 1.0  # Bias towards digit 3
