...
Fix: Restored pixel normalization step in preprocess_image (img = img / 255.0)
This ensures inputs are in [0, 1] range, matching training preprocessing.
"""
...
class MNISTClassifier:
    ...
    def preprocess_image(self, image_path):
        ...
        # FIX: Restore normalization step removed in v1.1
        # Normalize pixel values to [0, 1] which matches model training
        img = img / 255.0
