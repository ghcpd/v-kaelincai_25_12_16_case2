...
Fix: restored missing pixel normalization step in `preprocess_image`.
"""
...
class MNISTClassifier:
    ...
    def preprocess_image(self, image_path):
        ...
        # NOTE: This line was accidentally removed in v1.1. Restoring it fixes
        # preprocessing so the model receives inputs in the same range used
        # during training (0.0 - 1.0).
        img = img / 255.0
