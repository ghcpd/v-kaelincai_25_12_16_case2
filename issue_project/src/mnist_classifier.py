"""
MNIST Handwritten Digit Classifier - Version 1.1
Simple feedforward neural network for digit classification.

REGRESSION BUG: Pixel normalization (img = img / 255.0) was accidentally 
removed in v1.1, causing prediction failures on images.
"""
